...
class UserDao:
    ...
    def key_is_valid(self, key):
        return key=='city' or key=='birth_date'  or key=='phone' or key=='studying' or key=='description' or key=='address' or key=='job' or key=='name' or key=='internship' or key=='email' or key=='state' or key=='onesignal_playerID' or key == 'version_app' or key=='username'
